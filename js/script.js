...
function alterar(cpf) {
    ...
    for (let i = 0; i < clientes.length; i++) {
        ...
        if (cliente.cpf == cpf) {
            ...
            document.getElementById("tam-sapato").value = cliente.tamSapato
...
function salvar() {
    ...
    let tamSapato = document.getElementById("tam-sapato").value
    ...
    if (clienteAlterado == null) {
        ...
        clienteAlterado.tamSapato = tamSapato
...
function limparForm() {
    ...
    document.getElementById("tam-sapato").value = ""
...
function ordNome(){
    ...
    .then((response)=>{
        ...
        alert("Falha ao ordenar")
    })
}

function buscar(){
    let busca = document.getElementById("busca").value
    fetch(`http://localhost:3000/buscar?q=${busca}`,{
        headers:{
            "Content-type": "application/json"
        },
        method: "GET"
